...
public: \
	DECLARE_CLASS(AAttackEffect, AActor, COMPILED_IN_FLAGS(0 | CLASS_Config), CASTCLASS_None, TEXT("/Script/ProjectW"), NO_API) \
...
#define ProjectW_Source_ProjectW_AttackEffect_h_12_STANDARD_CONSTRUCTORS \
	...
	DECLARE_VTABLE_PTR_HELPER_CTOR(NO_API, AAttackEffect); \
	DEFINE_VTABLE_PTR_HELPER_CTOR_CALLER(AAttackEffect); \
private: \
	/** Private move- and copy-constructors, should never be used */ \
	NO_API AAttackEffect(AAttackEffect&&); \
	NO_API AAttackEffect(const AAttackEffect&); \
public:
...
template<> PROJECTW_API UClass* StaticClass<class AAttackEffect>();

#undef CURRENT_FILE_ID
#define CURRENT_FILE_ID ProjectW_Source_ProjectW_AttackEffect_h
